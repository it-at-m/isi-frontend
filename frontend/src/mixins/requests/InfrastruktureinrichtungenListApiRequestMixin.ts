...
import {
  ...
  InfrastruktureinrichtunglistenApi,
...
export default class InfrastruktureinrichtungenListApiRequestMixin extends Mixins(ErrorHandler) {
  ...
  constructor() {
    super();
    this.infrastruktureiInfrastruktureinrichtunglistenApi = new InfrastruktureinrichtunglistenApi(
  ...
  getInfrastruktureinrichtungenListElements(
    ...
    return this.infrastruktureiInfrastruktureinrichtunglistenApi
