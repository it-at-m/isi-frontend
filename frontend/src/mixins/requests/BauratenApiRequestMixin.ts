...
export default class BauratenApiRequestMixin extends Mixins(ErrorHandler) {
  ...
  createBaurate(dto: BaurateDto, showInInformationList: boolean): Promise<BaurateDto> {
    ...
    return this.bauratenApi
      .createBaurate(requestObject, RequestUtils.getPOSTConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  updateBaurate(dto: BaurateDto, showInInformationList: boolean): Promise<BaurateDto> {
    ...
    return this.bauratenApi
      .updateBaurate(requestObject, RequestUtils.getPUTConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getBaurate(id: string, showInInformationList: boolean): Promise<BaurateDto> {
    ...
    return this.bauratenApi
      .getBaurateById(requestObject, RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getBauraten(showInInformationList: boolean): Promise<Array<BaurateDto>> {
    return this.bauratenApi
      .getBauraten(RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  deleteBaurate(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.bauratenApi
      .deleteBaurateById(requestObject, RequestUtils.getDELETEConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
