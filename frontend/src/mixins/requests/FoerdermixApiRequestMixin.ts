...
export default class FoerdermixApiRequestMixin extends Mixins(ErrorHandler) {
  ...
  createFoerdermixStamm(dto: FoerdermixStammDto, showInInformationList: boolean): Promise<FoerdermixStammDto> {
    ...
    return this.foerdermixStammApi
      .saveFoerdermixStamm(requestObject, RequestUtils.getPOSTConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  updateFoerdermixStamm(dto: FoerdermixStammDto, showInInformationList: boolean): Promise<FoerdermixStammDto> {
    ...
    return this.foerdermixStammApi
      .updateFoerdermixStamm(requestObject, RequestUtils.getPUTConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getFoerdermix(id: string, showInInformationList: boolean): Promise<FoerdermixStammDto> {
    ...
    return this.foerdermixStammApi
      .getFoerdermixStammById(requestObject, RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  deleteFoerdermixStamm(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.foerdermixStammApi
      .deleteFoerdermixStammById(requestObject, RequestUtils.getDELETEConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
