...
@Component
export default class KinderkrippeApiRequestMixin extends Mixins(
  SaveLeaveMixin,
  ErrorHandler
) {
  ...
  createKinderkrippe(dto: KinderkrippeDto, showInInformationList: boolean): Promise<KinderkrippeDto> {
    ...
    return this.kinderkrippeApi.createKinderkrippe(requestObject, RequestUtils.getPOSTConfig())
      .then(response => {
        this.resetDirty();
        return response;
      })
  ...
  updateKinderkrippe(dto: KinderkrippeDto, showInInformationList: boolean): Promise<KinderkrippeDto> {
    ...
    return this.kinderkrippeApi.updateKinderkrippe(requestObject, RequestUtils.getPUTConfig())
      .then(response => {
        this.resetDirty();
        return response;
      })
  ...
  getKinderkrippen(showInInformationList: boolean): Promise<Array<KinderkrippeDto>> {
    return this.kinderkrippeApi.getKinderkrippen(RequestUtils.getGETConfig())
      .then(response => {
        return response;
      })
      .catch(error => {
  ...
  getKinderkrippeById(id: string, showInInformationList: boolean): Promise<KinderkrippeDto> {
    ...
    return this.kinderkrippeApi.getKinderkrippeById(requestObject, RequestUtils.getGETConfig())
      .then(response => {
        return response;
      })
      .catch(error => {
  ...
  deleteKinderkrippeById(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.kinderkrippeApi.deleteKinderkrippeById(requestObject, RequestUtils.getDELETEConfig())
      .then(response => {
        this.resetDirty();
        return response;
      })
