...
@Component
export default class HausFuerKinderApiRequestMixin extends Mixins(SaveLeaveMixin, ErrorHandler) {
  ...
  createHausFuerKinder(dto: HausFuerKinderDto, showInInformationList: boolean): Promise<HausFuerKinderDto> {
    ...
    return this.hausFuerKinderApi
      .createHausFuerKinder(requestObject, RequestUtils.getPOSTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  updateHausFuerKinder(dto: HausFuerKinderDto, showInInformationList: boolean): Promise<HausFuerKinderDto> {
    ...
    return this.hausFuerKinderApi
      .updateHausFuerKinder(requestObject, RequestUtils.getPUTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  getHaeuserFuerKinder(showInInformationList: boolean): Promise<Array<HausFuerKinderDto>> {
    return this.hausFuerKinderApi
      .getHaeuserFuerKinder(RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getHausFuerKinderById(id: string, showInInformationList: boolean): Promise<HausFuerKinderDto> {
    ...
    return this.hausFuerKinderApi
      .getHausFuerKinderById(requestObject, RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  deleteHausFuerKinderById(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.hausFuerKinderApi
      .deleteHausFuerKinderById(requestObject, RequestUtils.getDELETEConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
