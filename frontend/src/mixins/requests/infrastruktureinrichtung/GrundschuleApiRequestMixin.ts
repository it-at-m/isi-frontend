...
@Component
export default class GrundschuleApiRequestMixin extends Mixins(SaveLeaveMixin, ErrorHandler) {
  ...
  createGrundschule(dto: GrundschuleDto, showInInformationList: boolean): Promise<GrundschuleDto> {
    ...
    return this.grundschuleApi
      .createGrundschule(requestObject, RequestUtils.getPOSTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  updateGrundschule(dto: GrundschuleDto, showInInformationList: boolean): Promise<GrundschuleDto> {
    ...
    return this.grundschuleApi
      .updateGrundschule(requestObject, RequestUtils.getPUTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  getGrundschulen(showInInformationList: boolean): Promise<Array<GrundschuleDto>> {
    return this.grundschuleApi
      .getGrundschulen(RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getGrundschuleById(id: string, showInInformationList: boolean): Promise<GrundschuleDto> {
    ...
    return this.grundschuleApi
      .getGrundschuleById(requestObject, RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  deleteGrundschuleById(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.grundschuleApi
      .deleteGrundschuleById(requestObject, RequestUtils.getDELETEConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
