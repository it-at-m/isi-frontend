...
@Component
export default class KindergartenApiRequestMixin extends Mixins(SaveLeaveMixin, ErrorHandler) {
  ...
  createKindergarten(dto: KindergartenDto, showInInformationList: boolean): Promise<KindergartenDto> {
    ...
    return this.kindergartenApi
      .createKindergarten(requestObject, RequestUtils.getPOSTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  updateKindergarten(dto: KindergartenDto, showInInformationList: boolean): Promise<KindergartenDto> {
    ...
    return this.kindergartenApi
      .updateKindergarten(requestObject, RequestUtils.getPUTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  getKindergaerten(showInInformationList: boolean): Promise<Array<KindergartenDto>> {
    return this.kindergartenApi
      .getKindergaerten(RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getKindergartenById(id: string, showInInformationList: boolean): Promise<KindergartenDto> {
    ...
    return this.kindergartenApi
      .getKindergartenById(requestObject, RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  deleteKindergartenById(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.kindergartenApi
      .deleteKindergartenById(requestObject, RequestUtils.getDELETEConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
