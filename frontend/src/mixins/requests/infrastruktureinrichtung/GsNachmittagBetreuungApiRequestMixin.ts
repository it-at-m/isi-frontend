...
@Component
export default class GsNachmittagBetreuungApiRequestMixin extends Mixins(SaveLeaveMixin, ErrorHandler) {
  ...
  createGsNachmittagBetreuung(
    dto: GsNachmittagBetreuungDto,
    showInInformationList: boolean
  ): Promise<GsNachmittagBetreuungDto> {
    const requestObject: CreateGsNachmittagBetreuungRequest = {
      gsNachmittagBetreuungDto: dto,
    };
    return this.gsNachmittagBetreuungApi
      .createGsNachmittagBetreuung(requestObject, RequestUtils.getPOSTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  updateGsNachmittagBetreuung(
    ...
    return this.gsNachmittagBetreuungApi
      .updateGsNachmittagBetreuung(requestObject, RequestUtils.getPUTConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
  ...
  getGsNachmittagBetreuungen(showInInformationList: boolean): Promise<Array<GsNachmittagBetreuungDto>> {
    return this.gsNachmittagBetreuungApi
      .getGsNachmittagBetreuungen(RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  getGsNachmittagBetreuungById(id: string, showInInformationList: boolean): Promise<GsNachmittagBetreuungDto> {
    ...
    return this.gsNachmittagBetreuungApi
      .getGsNachmittagBetreuungById(requestObject, RequestUtils.getGETConfig())
      .then((response) => {
        return response;
      })
      .catch((error) => {
  ...
  deleteGsNachmittagBetreuungById(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.gsNachmittagBetreuungApi
      .deleteGsNachmittagBetreuungById(requestObject, RequestUtils.getDELETEConfig())
      .then((response) => {
        this.resetDirty();
        return response;
      })
