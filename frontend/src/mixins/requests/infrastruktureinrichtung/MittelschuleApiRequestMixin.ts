...
@Component
export default class MittelschuleApiRequestMixin extends Mixins(
  SaveLeaveMixin,
  ErrorHandler
) {
  ...
  createMittelschule(dto: MittelschuleDto, showInInformationList: boolean): Promise<MittelschuleDto> {
    ...
    return this.mittelschuleApi.createMittelschule(requestObject, RequestUtils.getPOSTConfig())
      .then(response => {
        this.resetDirty();
        return response;
      })
  ...
  updateMittelschule(dto: MittelschuleDto, showInInformationList: boolean): Promise<MittelschuleDto> {
    ...
    return this.mittelschuleApi.updateMittelschule(requestObject, RequestUtils.getPUTConfig())
      .then(response => {
        this.resetDirty();
        return response;
      })
  ...
  getMittelschulen(showInInformationList: boolean): Promise<Array<MittelschuleDto>> {
    return this.mittelschuleApi.getMittelschulen(RequestUtils.getGETConfig())
      .then(response => {
        return response;
      })
      .catch(error => {
  ...
  getMittelschuleById(id: string, showInInformationList: boolean): Promise<MittelschuleDto> {
    ...
    return this.mittelschuleApi.getMittelschuleById(requestObject, RequestUtils.getGETConfig())
      .then(response => {
        return response;
      })
      .catch(error => {
  ...
  deleteMittelschuleById(id: string, showInInformationList: boolean): Promise<void> {
    ...
    return this.mittelschuleApi.deleteMittelschuleById(requestObject, RequestUtils.getDELETEConfig())
      .then(response => {
        this.resetDirty();
        return response;
      })
