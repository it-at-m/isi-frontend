...
export default class Infrastruktureinrichtung extends Mixins(
  ...
  private gsNachmittagBetreuung: GsNachmittagBetreuungModel = new GsNachmittagBetreuungModel(createGsNachmittagBetreuungDto());
  ...
  private currentInfrastruktureinrichtungTyp: string = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Unspecified.toString();
  ...
  get lfdNr(): string {
    ...
    return !_.isNil(model) && !_.isNil(model.infrastruktureinrichtung.lfdNr) ? model.infrastruktureinrichtung.lfdNr.toString() : "";    
  }
  ...
  private async yesNoDialogYes(): Promise<void> {
    this.deleteInfrastruktureinrichtungTyp(this.infrastruktureinrichtungTyp, this.getInfrastruktureinrichtungModel()?.id as string);
    this.yesNoDialogNo();
  }
 
  get isKinderkrippe(): boolean {
    return this.currentInfrastruktureinrichtungTyp === InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kinderkrippe.toString();
  } 

  get isKindergarten(): boolean {
    return this.currentInfrastruktureinrichtungTyp === InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kindergarten.toString();
  } 

  get isHausFuerKinder(): boolean {
    return this.currentInfrastruktureinrichtungTyp === InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.HausFuerKinder.toString();
  } 

  get isGsNachmittagBetreuung(): boolean {
    return this.currentInfrastruktureinrichtungTyp === InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.GsNachmittagBetreuung.toString();
  } 

  get isGrundschule(): boolean {
    return this.currentInfrastruktureinrichtungTyp === InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Grundschule.toString();
  } 

  get isMittelschule(): boolean {
    return this.currentInfrastruktureinrichtungTyp === InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Mittelschule.toString();
  } 

  mounted(): void {
    this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Unspecified.toString();    
    this.getInfrastruktureinrichtungById(this.queryParameterInfrastruktureinrichtungTyp, this.queryParameterInfrastruktureinrichtungId);
    this.mode = this.isNewInfrastruktureinrichtung() ? DisplayMode.NEU : DisplayMode.AENDERUNG;
    this.buttonText = this.isNewInfrastruktureinrichtung()
      ? "Speichern"
      : "Aktualisieren";    
  }

  private isNewInfrastruktureinrichtung(): boolean {
    this.mode = _.isNil(this.queryParameterInfrastruktureinrichtungId) 
      ? DisplayMode.NEU
  ...
  private selectedInfrastruktureinrichtungChanged() {
    const infrastruktureinrichtungFromStore = this.$store.getters[Infrastruktureinrichtung.SEARCH_SELECTED_INFRASTRUKTUREINRICHTUNG];
  ...
  private async saveInfrastruktureinrichtung(): Promise<void> {
    if (this.validateForm()) {
      const validationMessage: string | null = this.validateInfrastruktureinrichtungTyp(this.infrastruktureinrichtungTyp);
  ...
  private async saveInfrastruktureinrichtungTyp(infrastruktureinrichtungTyp: string): Promise<void> {    
     switch (infrastruktureinrichtungTyp) {
       case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kinderkrippe.toString():         
         this.callSaveInfrastruktureinrichtung(this.mode === DisplayMode.NEU ? this.createKinderkrippe : this.updateKinderkrippe, this.kinderkrippe, true);
         break;
       case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kindergarten.toString():
         this.callSaveInfrastruktureinrichtung(this.mode === DisplayMode.NEU ? this.createKindergarten : this.updateKindergarten, this.kindergarten, true);
         break;
       case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.HausFuerKinder.toString():
         this.callSaveInfrastruktureinrichtung(this.mode === DisplayMode.NEU ? this.createHausFuerKinder : this.updateHausFuerKinder, this.hausFuerKinder, true);
         break;
       case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.GsNachmittagBetreuung.toString():
         this.callSaveInfrastruktureinrichtung(this.mode === DisplayMode.NEU ? this.createGsNachmittagBetreuung : this.updateGsNachmittagBetreuung, this.gsNachmittagBetreuung, true);
         break;
       case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Grundschule.toString():
         this.callSaveInfrastruktureinrichtung(this.mode === DisplayMode.NEU ? this.createGrundschule : this.updateGrundschule, this.grundschule, true);
         break;
       case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Mittelschule.toString():
         this.callSaveInfrastruktureinrichtung(this.mode === DisplayMode.NEU ? this.createMittelschule : this.updateMittelschule, this.mittelschule, true);
         break;
       default:
         break;
     }
  ...
  private async callSaveInfrastruktureinrichtung<T>(callback: (model: T, showInInformationList: boolean) => Promise <
    KinderkrippeDto | 
    KindergartenDto |
    HausFuerKinderDto |
    GsNachmittagBetreuungDto |
    GrundschuleDto |
    MittelschuleDto>, modelParam: T, showInInformationListParam: boolean): Promise<void> {
    await callback(modelParam, showInInformationListParam)
      .then((dto) => {
        this.handleSuccess(dto);
      });
  }

  private handleSuccess(dto:
    KinderkrippeDto |
    KindergartenDto |
    HausFuerKinderDto |
    GsNachmittagBetreuungDto |
  ...
  private saveInfrastruktureinrichtungInStore(infrastruktureinrichtungTyp: string, dto:
    KinderkrippeDto |
    KindergartenDto |
    HausFuerKinderDto |
    GsNachmittagBetreuungDto |
  ...
  private getModelOfDto(infrastruktureinrichtungTyp: string, dto: 
    KinderkrippeDto |
    KindergartenDto |
    HausFuerKinderDto |
    GsNachmittagBetreuungDto |
    ...
    undefined {
      switch (infrastruktureinrichtungTyp) {                
        ...
        case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.GsNachmittagBetreuung.toString():
          return new GsNachmittagBetreuungModel(!_.isNil(dto) ? dto as GsNachmittagBetreuungDto : createGsNachmittagBetreuungDto());
        case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Grundschule.toString():
  ...
  private setInfrastruktureinrichtungModel(infrastruktureinrichtungModel:    
    KinderkrippeModel |
    KindergartenModel |
    HausFuerKinderModel |
    GsNachmittagBetreuungModel |
    ...
    switch (infrastruktureinrichtungModel.infrastruktureinrichtungTyp.toString()) {
      case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kinderkrippe.toString():
        ...
        this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kinderkrippe;
        break;
      case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kindergarten.toString():
        this.kindergarten = _.cloneDeep(infrastruktureinrichtungModel as KindergartenModel);
        this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Kindergarten;
        break;
      case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.HausFuerKinder.toString():
        this.hausFuerKinder = _.cloneDeep(infrastruktureinrichtungModel as HausFuerKinderModel);
        this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.HausFuerKinder;
        break;
      case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.GsNachmittagBetreuung.toString():
        this.gsNachmittagBetreuung = _.cloneDeep(infrastruktureinrichtungModel as GsNachmittagBetreuungModel);
        this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.GsNachmittagBetreuung;
        break;
      case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Grundschule.toString():
        this.grundschule = _.cloneDeep(infrastruktureinrichtungModel as GrundschuleModel);
        this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Grundschule;
        break;
      case InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Mittelschule.toString():
        this.mittelschule = _.cloneDeep(infrastruktureinrichtungModel as MittelschuleModel);
        this.currentInfrastruktureinrichtungTyp = InfrastruktureinrichtungListElementDtoInfrastruktureinrichtungTypEnum.Mittelschule;
        break;
      default: 
        break;
    }
  ...
  private async getInfrastruktureinrichtungById(infrastruktureinrichtungTyp: string, id: string): Promise<void> {
    if (!_.isNil(infrastruktureinrichtungTyp)) {
      if (!_.isNil(id)) {
        ...
        this.$store.commit(Infrastruktureinrichtung.SEARCH_SELECTED_INFRASTRUKTUREINRICHTUNG, this.getModelOfDto(infrastruktureinrichtungTyp, undefined));
      }
    }      
  }

  private async callInfrastruktureinrichtungById(callback: (id: string, showInInformationList: boolean) => Promise <
    KinderkrippeDto |
    KindergartenDto |
    HausFuerKinderDto |
    GsNachmittagBetreuungDto |
    GrundschuleDto |
    MittelschuleDto>, idParam: string, infrastruktureinrichtungTyp: string): Promise<void> {
    await callback(idParam, true)
      .then((dto) => {
        this.$store.commit(Infrastruktureinrichtung.SEARCH_SELECTED_INFRASTRUKTUREINRICHTUNG, this.getModelOfDto(infrastruktureinrichtungTyp, dto));
  ...
  private async callDeleteInfrastruktureinrichtungById(callback: (id: string, showInInformationList: boolean) => Promise <void>,
    idParam: string): Promise<void> {
    await callback(idParam, true)
      .then(() => {
