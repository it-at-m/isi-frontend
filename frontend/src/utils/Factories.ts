...
export function createSearchQueryAndSortingModel(): SearchQueryAndSortingModel {
  const searchQueryAndSortingDto = {
    ...
    filterRealisierungVon: undefined,
    filterRealisierungBis: undefined,
    filterNurEigeneAbfragen: undefined,
    filterStatusAbfrage: undefined,
    filterSobonRelevantAbfrage: UncertainBoolean.Unspecified,
    ...
    filterStandVerfahrenAbfrage: undefined,
    filterInfrastruktureinrichtungStatus: undefined,
    filterStandVerfahrenBauvorhaben: undefined,
    filterSobonRelevantBauvorhaben: UncertainBoolean.Unspecified,
    page: undefined,
    pageSize: undefined,
