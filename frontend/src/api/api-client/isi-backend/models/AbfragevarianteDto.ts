...
export type AbfragevarianteDtoPlanungsrechtEnum =
  (typeof AbfragevarianteDtoPlanungsrechtEnum)[keyof typeof AbfragevarianteDtoPlanungsrechtEnum];
...
export function AbfragevarianteDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbfragevarianteDto {
  ...
  return {
    ...
    geschossflaecheWohnenGenehmigt: !exists(json, "geschossflaecheWohnenGenehmigt")
      ? undefined
      : json["geschossflaecheWohnenGenehmigt"],
    geschossflaecheWohnenFestgesetzt: !exists(json, "geschossflaecheWohnenFestgesetzt")
      ? undefined
      : json["geschossflaecheWohnenFestgesetzt"],
    geschossflaecheWohnenSoBoNursaechlich: !exists(json, "geschossflaecheWohnenSoBoNursaechlich")
      ? undefined
      : json["geschossflaecheWohnenSoBoNursaechlich"],
    geschossflaecheWohnenBestandswohnbaurecht: !exists(json, "geschossflaecheWohnenBestandswohnbaurecht")
      ? undefined
      : json["geschossflaecheWohnenBestandswohnbaurecht"],
    gesamtanzahlWe: !exists(json, "gesamtanzahlWe") ? undefined : json["gesamtanzahlWe"],
    anzahlWeBaurechtlichGenehmigt: !exists(json, "anzahlWeBaurechtlichGenehmigt")
      ? undefined
      : json["anzahlWeBaurechtlichGenehmigt"],
    anzahlWeBaurechtlichFestgesetzt: !exists(json, "anzahlWeBaurechtlichFestgesetzt")
      ? undefined
      : json["anzahlWeBaurechtlichFestgesetzt"],
    realisierungVon: json["realisierungVon"],
    realisierungBis: json["realisierungBis"],
    geschossflaecheGenossenschaftlicheWohnungen: !exists(json, "geschossflaecheGenossenschaftlicheWohnungen")
      ? undefined
      : json["geschossflaecheGenossenschaftlicheWohnungen"],
    sonderwohnformen: json["sonderwohnformen"],
    geschossflaecheStudentenwohnungen: !exists(json, "geschossflaecheStudentenwohnungen")
      ? undefined
      : json["geschossflaecheStudentenwohnungen"],
    geschossflaecheSeniorenwohnungen: !exists(json, "geschossflaecheSeniorenwohnungen")
      ? undefined
      : json["geschossflaecheSeniorenwohnungen"],
    geschossflaecheSonstiges: !exists(json, "geschossflaecheSonstiges") ? undefined : json["geschossflaecheSonstiges"],
    bauabschnitte: !exists(json, "bauabschnitte")
      ? undefined
      : (json["bauabschnitte"] as Array<any>).map(BauabschnittDtoFromJSON),
  };
}
...
export function AbfragevarianteDtoToJSON(value?: AbfragevarianteDto | null): any {
  ...
  return {
    ...
    bauabschnitte:
      value.bauabschnitte === undefined ? undefined : (value.bauabschnitte as Array<any>).map(BauabschnittDtoToJSON),
  };
}
