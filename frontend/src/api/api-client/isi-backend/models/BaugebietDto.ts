...
import { BaurateDto, BaurateDtoFromJSON, BaurateDtoFromJSONTyped, BaurateDtoToJSON } from "./BaurateDto";
...
export type BaugebietDtoBaugebietTypEnum =
  (typeof BaugebietDtoBaugebietTypEnum)[keyof typeof BaugebietDtoBaugebietTypEnum];
...
export function BaugebietDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaugebietDto {
  ...
  return {
    ...
    anzahlWohneinheitenBaurechtlichGenehmigt: !exists(json, "anzahlWohneinheitenBaurechtlichGenehmigt")
      ? undefined
      : json["anzahlWohneinheitenBaurechtlichGenehmigt"],
    anzahlWohneinheitenBaurechtlichFestgesetzt: !exists(json, "anzahlWohneinheitenBaurechtlichFestgesetzt")
      ? undefined
      : json["anzahlWohneinheitenBaurechtlichFestgesetzt"],
