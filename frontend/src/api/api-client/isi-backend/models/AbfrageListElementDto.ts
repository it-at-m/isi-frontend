...
export type AbfrageListElementDtoStandVorhabenEnum =
  (typeof AbfrageListElementDtoStandVorhabenEnum)[keyof typeof AbfrageListElementDtoStandVorhabenEnum];
...
export type AbfrageListElementDtoStatusAbfrageEnum =
  (typeof AbfrageListElementDtoStatusAbfrageEnum)[keyof typeof AbfrageListElementDtoStatusAbfrageEnum];
...
export type AbfrageListElementDtoTypeEnum =
  (typeof AbfrageListElementDtoTypeEnum)[keyof typeof AbfrageListElementDtoTypeEnum];
...
export function AbfrageListElementDtoToJSON(value?: AbfrageListElementDto | null): any {
  ...
  return {
    ...
    fristStellungnahme:
      value.fristStellungnahme === undefined ? undefined : value.fristStellungnahme.toISOString().substr(0, 10),
    type: value.type,
  };
}
