...
export class BauvorhabenApi extends runtime.BaseAPI {
   ...
   */
  async createBauvorhabenRaw(
    requestParameters: CreateBauvorhabenRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<BauvorhabenDto>> {
    if (requestParameters.bauvorhabenDto === null || requestParameters.bauvorhabenDto === undefined) {
      throw new runtime.RequiredError(
        "bauvorhabenDto",
        "Required parameter requestParameters.bauvorhabenDto was null or undefined when calling createBauvorhaben."
      );
    }
   ...
   */
  async deleteBauvorhabenRaw(
    requestParameters: DeleteBauvorhabenRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling deleteBauvorhaben."
      );
    }
   ...
   */
  async getBauvorhabenRaw(
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Array<BauvorhabenDto>>> {
    const queryParameters: any = {};
   ...
   */
  async getBauvorhabenByIdRaw(
    requestParameters: GetBauvorhabenByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<BauvorhabenDto>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling getBauvorhabenById."
      );
    }
   ...
   */
  async updateBauvorhabenRaw(
    requestParameters: UpdateBauvorhabenRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<BauvorhabenDto>> {
    if (requestParameters.bauvorhabenDto === null || requestParameters.bauvorhabenDto === undefined) {
      throw new runtime.RequiredError(
        "bauvorhabenDto",
        "Required parameter requestParameters.bauvorhabenDto was null or undefined when calling updateBauvorhaben."
      );
    }
