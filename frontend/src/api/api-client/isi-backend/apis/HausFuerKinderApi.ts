...
export class HausFuerKinderApi extends runtime.BaseAPI {
   ...
   */
  async createHausFuerKinderRaw(
    requestParameters: CreateHausFuerKinderRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<HausFuerKinderDto>> {
    if (requestParameters.hausFuerKinderDto === null || requestParameters.hausFuerKinderDto === undefined) {
      throw new runtime.RequiredError(
        "hausFuerKinderDto",
        "Required parameter requestParameters.hausFuerKinderDto was null or undefined when calling createHausFuerKinder."
      );
    }
   ...
   * Anlegen eines neuen Hauses für Kinder
   */
  async createHausFuerKinder(
    requestParameters: CreateHausFuerKinderRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<HausFuerKinderDto> {
   ...
   */
  async deleteHausFuerKinderByIdRaw(
    requestParameters: DeleteHausFuerKinderByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling deleteHausFuerKinderById."
      );
    }
   ...
   * Löschen eines Hauses für Kinder
   */
  async deleteHausFuerKinderById(
    requestParameters: DeleteHausFuerKinderByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<void> {
   ...
   */
  async getHaeuserFuerKinderRaw(
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Array<HausFuerKinderDto>>> {
    const queryParameters: any = {};
   ...
   * Lade alle Häuser für Kinder
   */
  async getHaeuserFuerKinder(
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<Array<HausFuerKinderDto>> {
   ...
   */
  async getHausFuerKinderByIdRaw(
    requestParameters: GetHausFuerKinderByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<HausFuerKinderDto>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling getHausFuerKinderById."
      );
    }
   ...
   */
  async updateHausFuerKinderRaw(
    requestParameters: UpdateHausFuerKinderRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<HausFuerKinderDto>> {
    if (requestParameters.hausFuerKinderDto === null || requestParameters.hausFuerKinderDto === undefined) {
      throw new runtime.RequiredError(
        "hausFuerKinderDto",
        "Required parameter requestParameters.hausFuerKinderDto was null or undefined when calling updateHausFuerKinder."
      );
    }
