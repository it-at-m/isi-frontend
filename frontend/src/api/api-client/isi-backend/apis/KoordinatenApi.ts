...
export class KoordinatenApi extends runtime.BaseAPI {
   ...
   */
  async utm32ToWgs84Raw(
    requestParameters: Utm32ToWgs84Request,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Wgs84Dto>> {
    if (requestParameters.utmDto === null || requestParameters.utmDto === undefined) {
      throw new runtime.RequiredError(
        "utmDto",
        "Required parameter requestParameters.utmDto was null or undefined when calling utm32ToWgs84."
      );
    }
   ...
   */
  async wgs84toUtm32Raw(
    requestParameters: Wgs84toUtm32Request,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<UtmDto>> {
    if (requestParameters.wgs84Dto === null || requestParameters.wgs84Dto === undefined) {
      throw new runtime.RequiredError(
        "wgs84Dto",
        "Required parameter requestParameters.wgs84Dto was null or undefined when calling wgs84toUtm32."
      );
    }
