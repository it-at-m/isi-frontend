...
export class KindergartenApi extends runtime.BaseAPI {
   ...
   */
  async createKindergartenRaw(
    requestParameters: CreateKindergartenRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<KindergartenDto>> {
    if (requestParameters.kindergartenDto === null || requestParameters.kindergartenDto === undefined) {
      throw new runtime.RequiredError(
        "kindergartenDto",
        "Required parameter requestParameters.kindergartenDto was null or undefined when calling createKindergarten."
      );
    }
   ...
   */
  async deleteKindergartenByIdRaw(
    requestParameters: DeleteKindergartenByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling deleteKindergartenById."
      );
    }
   ...
   */
  async getKindergaertenRaw(
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Array<KindergartenDto>>> {
    const queryParameters: any = {};
   ...
   */
  async getKindergartenByIdRaw(
    requestParameters: GetKindergartenByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<KindergartenDto>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling getKindergartenById."
      );
    }
   ...
   */
  async updateKindergartenRaw(
    requestParameters: UpdateKindergartenRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<KindergartenDto>> {
    if (requestParameters.kindergartenDto === null || requestParameters.kindergartenDto === undefined) {
      throw new runtime.RequiredError(
        "kindergartenDto",
        "Required parameter requestParameters.kindergartenDto was null or undefined when calling updateKindergarten."
      );
    }
