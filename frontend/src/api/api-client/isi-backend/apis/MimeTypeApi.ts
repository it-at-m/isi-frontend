...
export class MimeTypeApi extends runtime.BaseAPI {
   ...
   */
  async extractMediaTypeInformationForAllowedMediaTypeRaw(
    requestParameters: ExtractMediaTypeInformationForAllowedMediaTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<MimeTypeInformationDto>> {
    if (requestParameters.filepathDto === null || requestParameters.filepathDto === undefined) {
      throw new runtime.RequiredError(
        "filepathDto",
        "Required parameter requestParameters.filepathDto was null or undefined when calling extractMediaTypeInformationForAllowedMediaType."
      );
    }
