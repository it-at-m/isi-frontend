...
```typescript
import type { AbfragevarianteBaugenehmigungsverfahrenStartBearbeitungDto } from ''
...
const example = {
  ...
  "dokumente": null,
} satisfies AbfragevarianteBaugenehmigungsverfahrenStartBearbeitungDto
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteBaugenehmigungsverfahrenStartBearbeitungDto
