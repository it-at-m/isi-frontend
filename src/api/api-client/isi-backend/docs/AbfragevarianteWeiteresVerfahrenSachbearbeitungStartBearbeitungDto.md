...
```typescript
import type { AbfragevarianteWeiteresVerfahrenSachbearbeitungStartBearbeitungDto } from ''
...
const example = {
  ...
  "dokumente": null,
} satisfies AbfragevarianteWeiteresVerfahrenSachbearbeitungStartBearbeitungDto
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteWeiteresVerfahrenSachbearbeitungStartBearbeitungDto
