...
```typescript
import type { AbfragevarianteWeiteresVerfahrenRequestBody } from ''
...
} satisfies AbfragevarianteWeiteresVerfahrenRequestBody
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteWeiteresVerfahrenRequestBody
