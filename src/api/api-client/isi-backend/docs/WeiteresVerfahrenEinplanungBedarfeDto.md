...
```typescript
import type { WeiteresVerfahrenEinplanungBedarfeDto } from ''

// TODO: Update the object below with actual values
const example = {
  "abfragevariantenWeiteresVerfahren": null,
  "abfragevariantenSachbearbeitungWeiteresVerfahren": null,
} satisfies WeiteresVerfahrenEinplanungBedarfeDto
...
const exampleParsed = JSON.parse(exampleJSON) as WeiteresVerfahrenEinplanungBedarfeDto
