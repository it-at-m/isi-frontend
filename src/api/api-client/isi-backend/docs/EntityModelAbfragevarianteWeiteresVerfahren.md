...
```typescript
import type { EntityModelAbfragevarianteWeiteresVerfahren } from ''
...
const example = {
  ...
  "links": null,
} satisfies EntityModelAbfragevarianteWeiteresVerfahren
...
const exampleParsed = JSON.parse(exampleJSON) as EntityModelAbfragevarianteWeiteresVerfahren
