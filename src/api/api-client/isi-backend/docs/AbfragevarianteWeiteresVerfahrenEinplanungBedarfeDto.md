...
```typescript
import type { AbfragevarianteWeiteresVerfahrenEinplanungBedarfeDto } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteWeiteresVerfahrenEinplanungBedarfeDto
