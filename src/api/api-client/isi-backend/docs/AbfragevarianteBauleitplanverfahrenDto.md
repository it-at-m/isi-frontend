...
```typescript
import type { AbfragevarianteBauleitplanverfahrenDto } from ''
...
const example = {
  ...
  "dokumente": null,
} satisfies AbfragevarianteBauleitplanverfahrenDto
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteBauleitplanverfahrenDto
