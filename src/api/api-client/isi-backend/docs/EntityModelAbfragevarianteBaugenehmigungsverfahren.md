...
```typescript
import type { EntityModelAbfragevarianteBaugenehmigungsverfahren } from ''
...
const example = {
  ...
  "links": null,
} satisfies EntityModelAbfragevarianteBaugenehmigungsverfahren
...
const exampleParsed = JSON.parse(exampleJSON) as EntityModelAbfragevarianteBaugenehmigungsverfahren
