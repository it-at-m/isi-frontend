...
```typescript
import type { BaugenehmigungsverfahrenAngelegtDto } from ''
...
} satisfies BaugenehmigungsverfahrenAngelegtDto
...
const exampleParsed = JSON.parse(exampleJSON) as BaugenehmigungsverfahrenAngelegtDto
