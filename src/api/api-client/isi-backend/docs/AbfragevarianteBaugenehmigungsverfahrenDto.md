...
```typescript
import type { AbfragevarianteBaugenehmigungsverfahrenDto } from ''
...
const example = {
  ...
  "dokumente": null,
} satisfies AbfragevarianteBaugenehmigungsverfahrenDto
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteBaugenehmigungsverfahrenDto
