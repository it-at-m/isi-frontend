...
```typescript
import type { EntityModelAbfragevariante } from ''
...
const example = {
  ...
  "links": null,
} satisfies EntityModelAbfragevariante
...
const exampleParsed = JSON.parse(exampleJSON) as EntityModelAbfragevariante
