...
```typescript
import type { AbfragevarianteBauleitplanverfahrenEinpflegenBedarfsmeldungDto } from ''
...
} satisfies AbfragevarianteBauleitplanverfahrenEinpflegenBedarfsmeldungDto
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteBauleitplanverfahrenEinpflegenBedarfsmeldungDto
