...
```typescript
import type { AbfragevarianteBauleitplanverfahrenRequestBody } from ''
...
} satisfies AbfragevarianteBauleitplanverfahrenRequestBody
...
const exampleParsed = JSON.parse(exampleJSON) as AbfragevarianteBauleitplanverfahrenRequestBody
